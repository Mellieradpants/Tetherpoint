              ...
              {!isSelectedNode ? (
                ...
                <>
                  <FieldRow
                    label="assertion"
                    value={
                      currentVerification.assertion_detected ? "Detected" : "Not detected"
                    }
                  />
