...
SCHEMA_MODEL_MAP = {
    ...
    "RuleUnitReferencedSource": RuleUnitReferencedSource,
    "RuleUnit": RuleUnit,
    ...
    "GovernanceReferenceRole": GovernanceReferenceRole,
    "GovernanceGateResult": GovernanceGateResult,
    "GovernanceRecord": GovernanceRecord,
    "GovernanceCheckResult": GovernanceCheckResult,
    "GovernanceRecordResult": GovernanceRecordResult,
